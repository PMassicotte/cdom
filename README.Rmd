...
The `cdom_fit_exponential()` function fits an exponential curve to CDOM data using the simple model proposed by @jJerlov-1968, @lLundgren-1976, @Bricaud-Morel-Prieur-1981.
